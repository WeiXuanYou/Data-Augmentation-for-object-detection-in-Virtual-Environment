...
parse.add_argument('--is_show', action='store_true', default=False, help='initial weights path')
...
parse.add_argument('--epochs', type=float,default=5, help='')
parse.add_argument('--batch-size', type=int,default=8, help='')
#parse.add_argument('--', type=float,default=0.5, help='')
